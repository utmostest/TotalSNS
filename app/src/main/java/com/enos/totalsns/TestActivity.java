...
import com.enos.totalsns.data.UserDetails;
import com.enos.totalsns.data.source.remote.OAuthToken;
import com.enos.totalsns.data.source.remote.TwitterApi;
    ...
    Callback<OAuthToken> tokenCallback = new Callback<OAuthToken>() {
        ...
        public void onResponse(Call<OAuthToken> call, Response<OAuthToken> response) {
            if (response.isSuccessful()) {
                ...
                Toast.makeText(TestActivity.this, "Failure while requesting token", Toast.LENGTH_LONG).show();
    ...
    Callback<UserDetails> userDetailsCallback = new Callback<UserDetails>() {
        ...
        public void onResponse(Call<UserDetails> call, Response<UserDetails> response) {
            if (response.isSuccessful()) {
                ...
                Toast.makeText(TestActivity.this, "Failure while requesting user details", Toast.LENGTH_LONG).show();
