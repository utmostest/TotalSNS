...
// 멘션을 위한 테이블 생성을 위해 추가한 클래스
@Entity(tableName = "mention")
public class Mention implements Parcelable, Post {
    ...
    @Ignore
    public Mention(String tablePlusArticleId, long tableId, long articleId, String id, String name, String msg, String profile,
